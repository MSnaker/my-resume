...
\AddToHook{shipout/background}{%
    ...
    \begin{tikzpicture}[overlay, remember picture]
        ...
        \path (pagearea.north west) ++(+\oddsidemargin,-\topmargin-\headheight-\headsep) node[anchor=north west, shape=rectangle, inner sep=0, minimum width=\textwidth, minimum height=\textheight] (textarea) {};
...
\begin{textblock*}{\SideWidth}(\MyLeftMargin,0.5\MyTopMargin)
    ...
    \begin{tabu} to 0.9\MyColWidth {X[2,r] | X[7,l]}
        \includesvg[width = 1em]{images/mail.svg}          & \href{mailto:marco3bissaro@gmail.com}{marco3bissaro@gmail.com} \\ [.2em]
        \includesvg[height = 1em]{images/smartphone.svg}   & \href{tel:+393408000465}{+39 3408000465} \\ [.2em]
